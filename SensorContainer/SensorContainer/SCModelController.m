...
@interface SCModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation SCModelController
...
{   
    ...
    SCDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"SCDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(SCDataViewController *)viewController];
